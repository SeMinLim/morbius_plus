...
5. Rescan the proposed PWM and optimize its enrichment cutoff again. Accept it
   ...
   return. Stop on non-improvement, lack of support, or 3 proposals.
...
candidates remain eligible, with a maximum of **3 proposals** per candidate.
Including the initial PWM evaluation, each candidate requires at most **4 full
